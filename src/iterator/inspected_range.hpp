...
namespace rust {
	...
	template<
		...
		class Pointer   = T*,
		class Reference = T&
	> class InspectedRange : public RangeModifier<OriginRange, iterator, Category, T, Distance, Pointer, Reference> {

		typedef std::function<void(T)> InspectFunc_t;
		typedef InspectedRange<OriginRange, iterator, Category, T, Distance, Pointer, Reference> CurrentType;
